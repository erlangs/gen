...
func GetAllMigrations(ctx context.Context, page, pagesize int, order string) (results []*model.Migrations, totalRows int64, err error) {
...
// AddMigrations is a function to add a single record to migrations table in the test1 database
...
// UpdateMigrations is a function to update a single record from migrations table in the test1 database
...
// DeleteMigrations is a function to delete a single record from migrations table in the test1 database
// error - ErrNotFound, db Find error
