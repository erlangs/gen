...
// echo '{"email": "EpyHmcXkehPsmjMArSDdiwojY","token": "dHsSiRuFMhMVjieaVbpwEAGUE","created_at": "2150-05-30T00:46:27.095525744+08:00"}' | http POST "http://localhost:8080/passwordresets" X-Api-User:user123
func AddPasswordResets(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err := passwordresets.BeforeSave(); err != nil {
		returnError(ctx, w, r, dao.ErrBadParams)
	}
...
// echo '{"email": "EpyHmcXkehPsmjMArSDdiwojY","token": "dHsSiRuFMhMVjieaVbpwEAGUE","created_at": "2150-05-30T00:46:27.095525744+08:00"}' | http PUT "http://localhost:8080/passwordresets/hello world"  X-Api-User:user123
