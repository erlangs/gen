...
// echo '{"id": 69,"migration": "tvONwuarcpbXdYUcNAUIrYXyr","batch": 8}' | http POST "http://localhost:8080/migrations" X-Api-User:user123
func AddMigrations(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err := migrations.BeforeSave(); err != nil {
		returnError(ctx, w, r, dao.ErrBadParams)
	}
...
// echo '{"id": 69,"migration": "tvONwuarcpbXdYUcNAUIrYXyr","batch": 8}' | http PUT "http://localhost:8080/migrations/1"  X-Api-User:user123
