...
// echo '{"id": 6,"uuid": "jbCOlhkAbTZnMUDJAkOtYiLWc","connection": "OFKenSCwTWHTdINoIoZZDBUyg","queue": "FwTOwybVDJTOrnphkZTDrWCHE","payload": "ededDUSbryQBdRgbNfxidSSKt","exception": "qHlZgZWjXOSBhWYkCLdaHZGFm","failed_at": "2190-05-27T07:02:15.670291634+08:00"}' | http POST "http://localhost:8080/failedjobs" X-Api-User:user123
func AddFailedJobs(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err := failedjobs.BeforeSave(); err != nil {
		returnError(ctx, w, r, dao.ErrBadParams)
	}
...
// echo '{"id": 6,"uuid": "jbCOlhkAbTZnMUDJAkOtYiLWc","connection": "OFKenSCwTWHTdINoIoZZDBUyg","queue": "FwTOwybVDJTOrnphkZTDrWCHE","payload": "ededDUSbryQBdRgbNfxidSSKt","exception": "qHlZgZWjXOSBhWYkCLdaHZGFm","failed_at": "2190-05-27T07:02:15.670291634+08:00"}' | http PUT "http://localhost:8080/failedjobs/1"  X-Api-User:user123
