...
// echo '{"id": 61,"tokenable_type": "gdMVyURCuVncROoORyohuXJQX","tokenable_id": 20,"name": "esGMiVoScrXvZmSiiNYLscQrh","token": "sfXherqmJdsHjACQwnUeolwSE","abilities": "XrhnNkVHWdiTqMicepUbwDCjX","last_used_at": "2308-05-31T09:49:44.763339612+08:00","created_at": "2104-03-08T10:14:09.988813616+08:00","updated_at": "2030-06-23T11:14:14.815863712+08:00"}' | http POST "http://localhost:8080/personalaccesstokens" X-Api-User:user123
func AddPersonalAccessTokens(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err := personalaccesstokens.BeforeSave(); err != nil {
		returnError(ctx, w, r, dao.ErrBadParams)
	}
...
// echo '{"id": 61,"tokenable_type": "gdMVyURCuVncROoORyohuXJQX","tokenable_id": 20,"name": "esGMiVoScrXvZmSiiNYLscQrh","token": "sfXherqmJdsHjACQwnUeolwSE","abilities": "XrhnNkVHWdiTqMicepUbwDCjX","last_used_at": "2308-05-31T09:49:44.763339612+08:00","created_at": "2104-03-08T10:14:09.988813616+08:00","updated_at": "2030-06-23T11:14:14.815863712+08:00"}' | http PUT "http://localhost:8080/personalaccesstokens/1"  X-Api-User:user123
