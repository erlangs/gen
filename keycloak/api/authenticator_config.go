...
// echo '{"id": "igJKpOrSnHJkkiBulkJVLpHkl","alias": "mnsBherfnSWcJxBqOQAwXBlZZ","realm_id": "ZLuItsAbwudMPEuYCrAVIFMUP"}' | http POST "http://localhost:8080/authenticatorconfig" X-Api-User:user123
...
// echo '{"id": "igJKpOrSnHJkkiBulkJVLpHkl","alias": "mnsBherfnSWcJxBqOQAwXBlZZ","realm_id": "ZLuItsAbwudMPEuYCrAVIFMUP"}' | http PUT "http://localhost:8080/authenticatorconfig/hello world"  X-Api-User:user123
