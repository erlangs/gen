...
// echo '{"resource_id": "UDnWkmUmyCJDqgfcnlIDbQFgq","policy_id": "WEUQqgCCUdMGiIoUixkfXMNSs"}' | http POST "http://localhost:8080/resourcepolicy" X-Api-User:user123
...
// echo '{"resource_id": "UDnWkmUmyCJDqgfcnlIDbQFgq","policy_id": "WEUQqgCCUdMGiIoUixkfXMNSs"}' | http PUT "http://localhost:8080/resourcepolicy/hello world/hello world"  X-Api-User:user123
