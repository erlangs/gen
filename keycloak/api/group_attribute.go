...
// echo '{"id": "XnECukbXOIAmlVdiTWcqurgrG","name": "bGqygFVvFtQbMIDlsyGZxMlpg","value": "GXwNiVVHxfjSOHWrFsdhEqlMi","group_id": "lggVWjUCQjxppVrcqAvQljyZU"}' | http POST "http://localhost:8080/groupattribute" X-Api-User:user123
...
// echo '{"id": "XnECukbXOIAmlVdiTWcqurgrG","name": "bGqygFVvFtQbMIDlsyGZxMlpg","value": "GXwNiVVHxfjSOHWrFsdhEqlMi","group_id": "lggVWjUCQjxppVrcqAvQljyZU"}' | http PUT "http://localhost:8080/groupattribute/hello world"  X-Api-User:user123
