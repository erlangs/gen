...
// echo '{"resource_id": "vihTMJKaBwuiqExBIfMuqvyqA","value": "uTHUdaUvegBhruTfBfobmBQgQ"}' | http POST "http://localhost:8080/resourceuris" X-Api-User:user123
...
// echo '{"resource_id": "vihTMJKaBwuiqExBIfMuqvyqA","value": "uTHUdaUvegBhruTfBfobmBQgQ"}' | http PUT "http://localhost:8080/resourceuris/hello world/hello world"  X-Api-User:user123
