...
// echo '{"realm_id": "aNXQbaSUlkOitqbvEyuZPFKTK","locale": "RYfnMNDxrhWAfWIXpVhdCnWsf","texts": "civZADCnHTUqdStakYYfyylEO"}' | http POST "http://localhost:8080/realmlocalizations" X-Api-User:user123
...
// echo '{"realm_id": "aNXQbaSUlkOitqbvEyuZPFKTK","locale": "RYfnMNDxrhWAfWIXpVhdCnWsf","texts": "civZADCnHTUqdStakYYfyylEO"}' | http PUT "http://localhost:8080/realmlocalizations/hello world/hello world"  X-Api-User:user123
