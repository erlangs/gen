...
// echo '{"realm_id": "uoIjTtRuxJJkfPWtgXXEaSlWX","value": "XKmGCQubgPOlDukUBUEsfYRNY"}' | http POST "http://localhost:8080/realmsupportedlocales" X-Api-User:user123
...
// echo '{"realm_id": "uoIjTtRuxJJkfPWtgXXEaSlWX","value": "XKmGCQubgPOlDukUBUEsfYRNY"}' | http PUT "http://localhost:8080/realmsupportedlocales/hello world/hello world"  X-Api-User:user123
