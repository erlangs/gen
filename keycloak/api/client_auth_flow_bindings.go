...
// echo '{"client_id": "UaWfmoPKCwEkbgDjcamSInWTw","flow_id": "JfNPjnLjtvrQmFcKFluumLNop","binding_name": "wsOFrWDKtnaNgRVAFRilpvjRA"}' | http POST "http://localhost:8080/clientauthflowbindings" X-Api-User:user123
...
// echo '{"client_id": "UaWfmoPKCwEkbgDjcamSInWTw","flow_id": "JfNPjnLjtvrQmFcKFluumLNop","binding_name": "wsOFrWDKtnaNgRVAFRilpvjRA"}' | http PUT "http://localhost:8080/clientauthflowbindings/hello world/hello world"  X-Api-User:user123
