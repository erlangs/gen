...
// echo '{"role_id": "aktVuesQgErWnPIqkYKkUjHHo","group_id": "enmBNSLxLjLOvqPmqkAUpenSj"}' | http POST "http://localhost:8080/grouprolemapping" X-Api-User:user123
...
// echo '{"role_id": "aktVuesQgErWnPIqkYKkUjHHo","group_id": "enmBNSLxLjLOvqPmqkAUpenSj"}' | http PUT "http://localhost:8080/grouprolemapping/hello world/hello world"  X-Api-User:user123
