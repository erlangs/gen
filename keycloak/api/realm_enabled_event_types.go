...
// echo '{"realm_id": "qsPSVPExKPsrikTHSOiPBcGQk","value": "DdkrPOUBrCBpHYuIomcWMsdjs"}' | http POST "http://localhost:8080/realmenabledeventtypes" X-Api-User:user123
...
// echo '{"realm_id": "qsPSVPExKPsrikTHSOiPBcGQk","value": "DdkrPOUBrCBpHYuIomcWMsdjs"}' | http PUT "http://localhost:8080/realmenabledeventtypes/hello world/hello world"  X-Api-User:user123
