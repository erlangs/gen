...
// echo '{"client_id": "hpctYnfZbWoEuKuvNiSaXDPPA","value": "DLVZYTEnjYVXvAVisCqQdjsSB"}' | http POST "http://localhost:8080/redirecturis" X-Api-User:user123
...
// echo '{"client_id": "hpctYnfZbWoEuKuvNiSaXDPPA","value": "DLVZYTEnjYVXvAVisCqQdjsSB"}' | http PUT "http://localhost:8080/redirecturis/hello world/hello world"  X-Api-User:user123
