...
// echo '{"policy_id": "dLojwwrQgibTfFvZHhbprxnXb","name": "NQXvfTwWwCqrqXBhqGcZVqGwG","value": "xUilURaCbImOFILuJrbqyBEyS"}' | http POST "http://localhost:8080/policyconfig" X-Api-User:user123
...
// echo '{"policy_id": "dLojwwrQgibTfFvZHhbprxnXb","name": "NQXvfTwWwCqrqXBhqGcZVqGwG","value": "xUilURaCbImOFILuJrbqyBEyS"}' | http PUT "http://localhost:8080/policyconfig/hello world/hello world"  X-Api-User:user123
