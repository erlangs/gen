...
// echo '{"name": "CfDGwrxwwRKXCGLJgIRyBgJwf","value": "MvLdfInGLYLDAuARJKwmTDcSH","client_session": "mwBIJwhPVvVGyueZBWfpXeYTF"}' | http POST "http://localhost:8080/clientusersessionnote" X-Api-User:user123
...
// echo '{"name": "CfDGwrxwwRKXCGLJgIRyBgJwf","value": "MvLdfInGLYLDAuARJKwmTDcSH","client_session": "mwBIJwhPVvVGyueZBWfpXeYTF"}' | http PUT "http://localhost:8080/clientusersessionnote/hello world/hello world"  X-Api-User:user123
