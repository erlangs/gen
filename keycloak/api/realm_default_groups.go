...
// echo '{"realm_id": "yNoWUCFryeYnNRHMNyXYXmuDu","group_id": "AROKPrMIZJrQikXDAAqnWJiFc"}' | http POST "http://localhost:8080/realmdefaultgroups" X-Api-User:user123
...
// echo '{"realm_id": "yNoWUCFryeYnNRHMNyXYXmuDu","group_id": "AROKPrMIZJrQikXDAAqnWJiFc"}' | http PUT "http://localhost:8080/realmdefaultgroups/hello world/hello world"  X-Api-User:user123
