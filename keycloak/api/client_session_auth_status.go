...
// echo '{"authenticator": "giAqhgYBQydghwUwTUTpgtaFQ","status": 58,"client_session": "GRCXOVleodNJFtTJpNprSTbVn"}' | http POST "http://localhost:8080/clientsessionauthstatus" X-Api-User:user123
...
// echo '{"authenticator": "giAqhgYBQydghwUwTUTpgtaFQ","status": 58,"client_session": "GRCXOVleodNJFtTJpNprSTbVn"}' | http PUT "http://localhost:8080/clientsessionauthstatus/hello world/hello world"  X-Api-User:user123
