...
// echo '{"protocol_mapper_id": "OOgpyohTTgLPkNkfAZZjCbaXl","value": "hNdmwlfUJudaodnJHSwDBgyVs","name": "CEpnZcygNnWXBqEjYgmDPlZyJ"}' | http POST "http://localhost:8080/protocolmapperconfig" X-Api-User:user123
...
// echo '{"protocol_mapper_id": "OOgpyohTTgLPkNkfAZZjCbaXl","value": "hNdmwlfUJudaodnJHSwDBgyVs","name": "CEpnZcygNnWXBqEjYgmDPlZyJ"}' | http PUT "http://localhost:8080/protocolmapperconfig/hello world/hello world"  X-Api-User:user123
