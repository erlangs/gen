...
// echo '{"name": "LpsgaDKJSHQsSiMpNFLZDUBOH","realm_id": "HXTLNcdpfMNxTMqmRjAEjBVae","value": "tepPuqrJKqapGLDbAWIajxFYI"}' | http POST "http://localhost:8080/realmattribute" X-Api-User:user123
...
// echo '{"name": "LpsgaDKJSHQsSiMpNFLZDUBOH","realm_id": "HXTLNcdpfMNxTMqmRjAEjBVae","value": "tepPuqrJKqapGLDbAWIajxFYI"}' | http PUT "http://localhost:8080/realmattribute/hello world/hello world"  X-Api-User:user123
