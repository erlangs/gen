...
// echo '{"id": "PqfVGeGvjsqcttvdmesgoBVvZ","name": "bhvTvYUOKxVbFGuJxajvaLCgo","value": "FrYkZHZuGRogwAyvphvqOsNct","resource_id": "rtbFyVUNFZDbuMlcDYwjbRYWY"}' | http POST "http://localhost:8080/resourceattribute" X-Api-User:user123
...
// echo '{"id": "PqfVGeGvjsqcttvdmesgoBVvZ","name": "bhvTvYUOKxVbFGuJxajvaLCgo","value": "FrYkZHZuGRogwAyvphvqOsNct","resource_id": "rtbFyVUNFZDbuMlcDYwjbRYWY"}' | http PUT "http://localhost:8080/resourceattribute/hello world"  X-Api-User:user123
