...
// echo '{"realm_id": "YumyxkFBeVtemZAnNNVCGRUJD","scope_id": "qpThVaLalUSZYOsMjRlmcWZLj","default_scope": false}' | http POST "http://localhost:8080/defaultclientscope" X-Api-User:user123
...
// echo '{"realm_id": "YumyxkFBeVtemZAnNNVCGRUJD","scope_id": "qpThVaLalUSZYOsMjRlmcWZLj","default_scope": false}' | http PUT "http://localhost:8080/defaultclientscope/hello world/hello world"  X-Api-User:user123
