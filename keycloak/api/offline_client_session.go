...
// echo '{"user_session_id": "aUwTFqXppFhOFwVFjedeeGgRR","client_id": "UpBHWYrCaeCXTbNJyREdrfEam","offline_flag": "htIOwVjdsGrGaiPOvlJVqnhFE","timestamp": 16,"data": "qIlFCmmOoTTPdKHrwTCeNMfMO","client_storage_provider": "rNQaQRIAHupmrNXQwgXBThhgR","external_client_id": "AVEFdShRhkEATACSuEbuSkKto"}' | http POST "http://localhost:8080/offlineclientsession" X-Api-User:user123
