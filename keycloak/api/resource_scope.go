...
// echo '{"resource_id": "obbyCDduypmlvsTmDlxOXejoq","scope_id": "IiWuSvYnPhmHCqJXGUitpPQNU"}' | http POST "http://localhost:8080/resourcescope" X-Api-User:user123
...
// echo '{"resource_id": "obbyCDduypmlvsTmDlxOXejoq","scope_id": "IiWuSvYnPhmHCqJXGUitpPQNU"}' | http PUT "http://localhost:8080/resourcescope/hello world/hello world"  X-Api-User:user123
