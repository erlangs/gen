...
// echo '{"role_id": "lLQmmTxNnQeNPqNyLoYNdVQlF","user_id": "OjxikHooktSOKRIWqlfLLtymE"}' | http POST "http://localhost:8080/userrolemapping" X-Api-User:user123
...
// echo '{"role_id": "lLQmmTxNnQeNPqNyLoYNdVQlF","user_id": "OjxikHooktSOKRIWqlfLLtymE"}' | http PUT "http://localhost:8080/userrolemapping/hello world/hello world"  X-Api-User:user123
