...
// echo '{"policy_id": "uXPeXMdJxsYygeSQUnoghuPNj","associated_policy_id": "PAeMVercJMfGgqkOFalNSMOOd"}' | http POST "http://localhost:8080/associatedpolicy" X-Api-User:user123
...
// echo '{"policy_id": "uXPeXMdJxsYygeSQUnoghuPNj","associated_policy_id": "PAeMVercJMfGgqkOFalNSMOOd"}' | http PUT "http://localhost:8080/associatedpolicy/hello world/hello world"  X-Api-User:user123
