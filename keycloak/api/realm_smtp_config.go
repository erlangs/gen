...
// echo '{"realm_id": "KqPBAvGQDWqZDGYplVLXULlVH","value": "eADtVCKMYFNDQeVTGCbPqMJJe","name": "CnOTvNuDIQSBQgJfkgKQfkFaf"}' | http POST "http://localhost:8080/realmsmtpconfig" X-Api-User:user123
...
// echo '{"realm_id": "KqPBAvGQDWqZDGYplVLXULlVH","value": "eADtVCKMYFNDQeVTGCbPqMJJe","name": "CnOTvNuDIQSBQgJfkgKQfkFaf"}' | http PUT "http://localhost:8080/realmsmtpconfig/hello world/hello world"  X-Api-User:user123
