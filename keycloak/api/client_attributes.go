...
// echo '{"client_id": "NusMUlbQbdoxNfCjtDeLjSLNE","value": "AjaXhjXOZAFfYZJuxobUPZYTK","name": "SpHOfiwebYPmeQrDLSUudKbxW"}' | http POST "http://localhost:8080/clientattributes" X-Api-User:user123
...
// echo '{"client_id": "NusMUlbQbdoxNfCjtDeLjSLNE","value": "AjaXhjXOZAFfYZJuxobUPZYTK","name": "SpHOfiwebYPmeQrDLSUudKbxW"}' | http PUT "http://localhost:8080/clientattributes/hello world/hello world"  X-Api-User:user123
