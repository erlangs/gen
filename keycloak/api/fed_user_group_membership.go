...
// echo '{"group_id": "rNwvHXJqqucrBEtjeJbMjrAwl","user_id": "yXUgTgoVuPyTkLVIRxhqRkfDG","realm_id": "WadofeOhigHijFmPchHxvZywJ","storage_provider_id": "yhwhTKpohdwrVQQDgHFYvStXK"}' | http POST "http://localhost:8080/fedusergroupmembership" X-Api-User:user123
...
// echo '{"group_id": "rNwvHXJqqucrBEtjeJbMjrAwl","user_id": "yXUgTgoVuPyTkLVIRxhqRkfDG","realm_id": "WadofeOhigHijFmPchHxvZywJ","storage_provider_id": "yhwhTKpohdwrVQQDgHFYvStXK"}' | http PUT "http://localhost:8080/fedusergroupmembership/hello world/hello world"  X-Api-User:user123
