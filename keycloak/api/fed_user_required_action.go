...
// echo '{"required_action": "srqXOFygsCgEZilFmIHSYIMSM","user_id": "gSunetDNiQqkyROPehTEFwYOS","realm_id": "VjaCBbopJYSoYMEbSpaSDCWVr","storage_provider_id": "fSLtIfmQDMmHVRdYcyubfOKDH"}' | http POST "http://localhost:8080/feduserrequiredaction" X-Api-User:user123
...
// echo '{"required_action": "srqXOFygsCgEZilFmIHSYIMSM","user_id": "gSunetDNiQqkyROPehTEFwYOS","realm_id": "VjaCBbopJYSoYMEbSpaSDCWVr","storage_provider_id": "fSLtIfmQDMmHVRdYcyubfOKDH"}' | http PUT "http://localhost:8080/feduserrequiredaction/hello world/hello world"  X-Api-User:user123
