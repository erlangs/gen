...
// echo '{"id": "JlPHPMoOuHmIKMApWfTcUhgtU","storage_provider_id": "WFbIgLqOUbFrKibFKSZsEGwDd","realm_id": "mDIccmPSXGylUCJaRlGemqsDp"}' | http POST "http://localhost:8080/federateduser" X-Api-User:user123
...
// echo '{"id": "JlPHPMoOuHmIKMApWfTcUhgtU","storage_provider_id": "WFbIgLqOUbFrKibFKSZsEGwDd","realm_id": "mDIccmPSXGylUCJaRlGemqsDp"}' | http PUT "http://localhost:8080/federateduser/hello world"  X-Api-User:user123
