...
// echo '{"id": "RhlxNqtKRjxiRPwSKhcgmxgpd","realm_id": "NPhgsXgNapAWVQwMDLoQmGuml","timestamp": 6,"expiration": 37,"count": 17,"remaining_count": 95}' | http POST "http://localhost:8080/clientinitialaccess" X-Api-User:user123
...
// echo '{"id": "RhlxNqtKRjxiRPwSKhcgmxgpd","realm_id": "NPhgsXgNapAWVQwMDLoQmGuml","timestamp": 6,"expiration": 37,"count": 17,"remaining_count": 95}' | http PUT "http://localhost:8080/clientinitialaccess/hello world"  X-Api-User:user123
