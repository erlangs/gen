...
// echo '{"client_id": "bqZVIRFXqTfmLbInnTGNHXJlf","role_id": "lTeeFxYdDoNYycTvJBoPUnuXZ"}' | http POST "http://localhost:8080/scopemapping" X-Api-User:user123
...
// echo '{"client_id": "bqZVIRFXqTfmLbInnTGNHXJlf","role_id": "lTeeFxYdDoNYycTvJBoPUnuXZ"}' | http PUT "http://localhost:8080/scopemapping/hello world/hello world"  X-Api-User:user123
