...
// echo '{"composite": "aRaKuxkrgPolCyvHTOWdAWMXS","child_role": "qJbWbZPjyaYsbJqMOePGQYfUd"}' | http POST "http://localhost:8080/compositerole" X-Api-User:user123
...
// echo '{"composite": "aRaKuxkrgPolCyvHTOWdAWMXS","child_role": "qJbWbZPjyaYsbJqMOePGQYfUd"}' | http PUT "http://localhost:8080/compositerole/hello world/hello world"  X-Api-User:user123
