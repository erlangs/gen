...
// echo '{"authenticator_id": "WpVfWVCLAKKHUouCqVPixPNWd","value": "ojIcDtVArsTOaUrveSVDwUCBN","name": "yaWtJSXsNrgLqqLehfKyUDCun"}' | http POST "http://localhost:8080/authenticatorconfigentry" X-Api-User:user123
...
// echo '{"authenticator_id": "WpVfWVCLAKKHUouCqVPixPNWd","value": "ojIcDtVArsTOaUrveSVDwUCBN","name": "yaWtJSXsNrgLqqLehfKyUDCun"}' | http PUT "http://localhost:8080/authenticatorconfigentry/hello world/hello world"  X-Api-User:user123
