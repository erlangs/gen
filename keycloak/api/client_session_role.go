...
// echo '{"role_id": "iKOwODqRkvjTaWBcgmosjdnSn","client_session": "HyYaZFaSlyPCSwdctAVqQCuMh"}' | http POST "http://localhost:8080/clientsessionrole" X-Api-User:user123
...
// echo '{"role_id": "iKOwODqRkvjTaWBcgmosjdnSn","client_session": "HyYaZFaSlyPCSwdctAVqQCuMh"}' | http PUT "http://localhost:8080/clientsessionrole/hello world/hello world"  X-Api-User:user123
