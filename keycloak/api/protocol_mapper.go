...
// echo '{"id": "nTaArRTldXPfYmjXAiVDdnPqC","name": "UmOSrHxrdLpUJTgqooSEIMngP","protocol": "CPbxeqeCOIjRDceLdhpyEebJg","protocol_mapper_name": "VwGxKGTThWnHahFYeqtUmysPY","client_id": "PNuZZyVOesBySFsfZbeSQUaCj","client_scope_id": "HErbwtMwxrZZforemhikUkteX"}' | http POST "http://localhost:8080/protocolmapper" X-Api-User:user123
...
// echo '{"id": "nTaArRTldXPfYmjXAiVDdnPqC","name": "UmOSrHxrdLpUJTgqooSEIMngP","protocol": "CPbxeqeCOIjRDceLdhpyEebJg","protocol_mapper_name": "VwGxKGTThWnHahFYeqtUmysPY","client_id": "PNuZZyVOesBySFsfZbeSQUaCj","client_scope_id": "HErbwtMwxrZZforemhikUkteX"}' | http PUT "http://localhost:8080/protocolmapper/hello world"  X-Api-User:user123
