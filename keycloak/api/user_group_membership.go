...
// echo '{"group_id": "urpKMMpOMZnOtAaUNwUoGBfQI","user_id": "WOrloDQYlyIUhGTvvUqXILUaR"}' | http POST "http://localhost:8080/usergroupmembership" X-Api-User:user123
...
// echo '{"group_id": "urpKMMpOMZnOtAaUNwUoGBfQI","user_id": "WOrloDQYlyIUhGTvvUqXILUaR"}' | http PUT "http://localhost:8080/usergroupmembership/hello world/hello world"  X-Api-User:user123
