...
// echo '{"client_id": "quHAJYEuritytwWkPGxQdmFMX","scope_id": "sTdMvLSlUWdeAkndufgjiZakO","default_scope": false}' | http POST "http://localhost:8080/clientscopeclient" X-Api-User:user123
...
// echo '{"client_id": "quHAJYEuritytwWkPGxQdmFMX","scope_id": "sTdMvLSlUWdeAkndufgjiZakO","default_scope": false}' | http PUT "http://localhost:8080/clientscopeclient/hello world/hello world"  X-Api-User:user123
