...
// echo '{"name": "hiKlBumFbgIKbCNVHMEaspOiX","value": "yaTdEGlWfxcGgShYwYTVphqCZ","client_session": "CFupDLhVMfkPQPCvDhAORqJLr"}' | http POST "http://localhost:8080/clientsessionnote" X-Api-User:user123
...
// echo '{"name": "hiKlBumFbgIKbCNVHMEaspOiX","value": "yaTdEGlWfxcGgShYwYTVphqCZ","client_session": "CFupDLhVMfkPQPCvDhAORqJLr"}' | http PUT "http://localhost:8080/clientsessionnote/hello world/hello world"  X-Api-User:user123
