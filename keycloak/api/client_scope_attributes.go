...
// echo '{"scope_id": "rBAqMFnfgdrQxtqtCohtlHDIH","value": "gEwnkvUttETAlgufQLvKsCvsM","name": "RFMIrAYarEBkccDsoVBtKGMjE"}' | http POST "http://localhost:8080/clientscopeattributes" X-Api-User:user123
...
// echo '{"scope_id": "rBAqMFnfgdrQxtqtCohtlHDIH","value": "gEwnkvUttETAlgufQLvKsCvsM","name": "RFMIrAYarEBkccDsoVBtKGMjE"}' | http PUT "http://localhost:8080/clientscopeattributes/hello world/hello world"  X-Api-User:user123
