...
// echo '{"user_consent_id": "oBwLWgiMGJnqJSgjMkFQcqQEQ","scope_id": "VCqTlIvlrRVAodEoluFCBvIIG"}' | http POST "http://localhost:8080/userconsentclientscope" X-Api-User:user123
...
// echo '{"user_consent_id": "oBwLWgiMGJnqJSgjMkFQcqQEQ","scope_id": "VCqTlIvlrRVAodEoluFCBvIIG"}' | http PUT "http://localhost:8080/userconsentclientscope/hello world/hello world"  X-Api-User:user123
