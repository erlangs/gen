...
// echo '{"user_id": "XXnPamUYrxonjAgIkhJNEUIVf","required_action": "TjTZCeFJSZUAHVnBDPfwtotQT"}' | http POST "http://localhost:8080/userrequiredaction" X-Api-User:user123
...
// echo '{"user_id": "XXnPamUYrxonjAgIkhJNEUIVf","required_action": "TjTZCeFJSZUAHVnBDPfwtotQT"}' | http PUT "http://localhost:8080/userrequiredaction/hello world/hello world"  X-Api-User:user123
