...
// echo '{"client_id": "ldrQlagrIjRmKonhKKpWUxpcO","value": "ljqIgjZyVdIosoMdXkjPVgGJP"}' | http POST "http://localhost:8080/weborigins" X-Api-User:user123
...
// echo '{"client_id": "ldrQlagrIjRmKonhKKpWUxpcO","value": "ljqIgjZyVdIosoMdXkjPVgGJP"}' | http PUT "http://localhost:8080/weborigins/hello world/hello world"  X-Api-User:user123
