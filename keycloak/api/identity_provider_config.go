...
// echo '{"identity_provider_id": "kxuaBWvDbonXiNdsIiaZomQDQ","value": "YBynjFCTWYFxOGVAfXsFHbNkr","name": "hxlWqbtvoyLkMNKvjrOvuGcAR"}' | http POST "http://localhost:8080/identityproviderconfig" X-Api-User:user123
...
// echo '{"identity_provider_id": "kxuaBWvDbonXiNdsIiaZomQDQ","value": "YBynjFCTWYFxOGVAfXsFHbNkr","name": "hxlWqbtvoyLkMNKvjrOvuGcAR"}' | http PUT "http://localhost:8080/identityproviderconfig/hello world/hello world"  X-Api-User:user123
