...
// echo '{"role_id": "GNgKWjiagNKJprYOwZpLLpokx","user_id": "jlfoMjbsydwPpBdnvLVBfNkNn","realm_id": "ekeuXqAuZFrwHkNoqwIqyWhqd","storage_provider_id": "qveWuBYLRijOZeTdUvLeresWh"}' | http POST "http://localhost:8080/feduserrolemapping" X-Api-User:user123
...
// echo '{"role_id": "GNgKWjiagNKJprYOwZpLLpokx","user_id": "jlfoMjbsydwPpBdnvLVBfNkNn","realm_id": "ekeuXqAuZFrwHkNoqwIqyWhqd","storage_provider_id": "qveWuBYLRijOZeTdUvLeresWh"}' | http PUT "http://localhost:8080/feduserrolemapping/hello world/hello world"  X-Api-User:user123
