...
// echo '{"name": "wgCkAOveYRexNelltrEtrlJtP","value": "ReScLBbkVrroaCQkjxlbdwZDT","user_id": "nVXUIwpFubHaBqhtMbyuBOvbQ","id": "HcCBNCrfoWaQFVoCwARYuFETT"}' | http POST "http://localhost:8080/userattribute" X-Api-User:user123
...
// echo '{"name": "wgCkAOveYRexNelltrEtrlJtP","value": "ReScLBbkVrroaCQkjxlbdwZDT","user_id": "nVXUIwpFubHaBqhtMbyuBOvbQ","id": "HcCBNCrfoWaQFVoCwARYuFETT"}' | http PUT "http://localhost:8080/userattribute/hello world"  X-Api-User:user123
