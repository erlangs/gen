...
// echo '{"user_session_id": "mOLLENBqvrvpLSOTWNJiCNFEF","user_id": "ChEbwjSNvhVaCbNfkyIwfTpEr","realm_id": "BMVUhigqBuARsIqhlfhcuulvi","created_on": 96,"offline_flag": "gghwLbYRSWxDcoLoZKhIePXWK","data": "PcNifCwJvimdbALuliqEXrEPm","last_session_refresh": 33}' | http POST "http://localhost:8080/offlineusersession" X-Api-User:user123
...
// echo '{"user_session_id": "mOLLENBqvrvpLSOTWNJiCNFEF","user_id": "ChEbwjSNvhVaCbNfkyIwfTpEr","realm_id": "BMVUhigqBuARsIqhlfhcuulvi","created_on": 96,"offline_flag": "gghwLbYRSWxDcoLoZKhIePXWK","data": "PcNifCwJvimdbALuliqEXrEPm","last_session_refresh": 33}' | http PUT "http://localhost:8080/offlineusersession/hello world/hello world"  X-Api-User:user123
