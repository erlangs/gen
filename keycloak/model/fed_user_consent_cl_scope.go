...
func (f *FedUserConsentClScope) TableName() string {
	return "fed_user_consent_cl_scope"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (f *FedUserConsentClScope) BeforeSave(tx *gorm.DB) error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (f *FedUserConsentClScope) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (f *FedUserConsentClScope) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (f *FedUserConsentClScope) TableInfo() *TableInfo {
	return fed_user_consent_cl_scopeTableInfo
}
