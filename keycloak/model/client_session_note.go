...
JSON Sample
-------------------------------------
{    "name": "OBUgPPXFXjOGOCbSadhoXMUhc",    "value": "JZSDbKrbKrmbIfJXEbNvUwKXB",    "client_session": "dFCpWwonkbgLInufPNIrHTlBM"}



*/

// ClientSessionNote struct is a row record of the client_session_note table in the keycloak database
type ClientSessionNote struct {
	//[ 0] name                                           VARCHAR(255)         null: false  primary: true   isArray: false  auto: false  col: VARCHAR         len: 255     default: []
...
var client_session_noteTableInfo = &TableInfo{
...
func (c *ClientSessionNote) TableName() string {
	return "client_session_note"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (c *ClientSessionNote) BeforeSave(tx *gorm.DB) error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (c *ClientSessionNote) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (c *ClientSessionNote) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (c *ClientSessionNote) TableInfo() *TableInfo {
	return client_session_noteTableInfo
}
