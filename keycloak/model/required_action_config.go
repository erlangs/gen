...
JSON Sample
-------------------------------------
{    "required_action_id": "hReIadZFmVwZctePHejTExofL",    "value": "PMWhheSCBIwKcRMeZDxwsnqoW",    "name": "dvjukJdilDRjRflptZEbGiFBI"}
...
type RequiredActionConfig struct {
	//[ 0] required_action_id                             VARCHAR(36)          null: false  primary: true   isArray: false  auto: false  col: VARCHAR         len: 36      default: []
	RequiredActionID string `gorm:"primary_key;column:required_action_id;type:VARCHAR;size:36;" json:"required_action_id"`
	//[ 1] value                                          TEXT                 null: true   primary: false  isArray: false  auto: false  col: TEXT            len: -1      default: []
