...
JSON Sample
-------------------------------------
{    "id": "lbHBLBmpUwgxeeYIbFMOnIfGq",    "access_code_lifespan": 31,    "user_action_lifespan": 8,    "access_token_lifespan": 84,    "account_theme": "VClDmWsBPTnkKHAdAxLvtHTwM",    "admin_theme": "ALiVODODrokdDwMMZmTiiJyix",    "email_theme": "hlmHkpWEPESZxTDZkEVrXDHqq",    "enabled": true,    "events_enabled": true,    "events_expiration": 59,    "login_theme": "jrKbOiTSohQiJdCUdSkxooFZB",    "name": "WyrMcZaLCZPutjUykMrlbtlMh",    "not_before": 6,    "password_policy": "iIuDKltOWcvDssbCXaKLsJXgS",    "registration_allowed": false,    "remember_me": true,    "reset_password_allowed": false,    "social": true,    "ssl_required": "PdTpALpGLPudFLxcZABJJhrGT",    "sso_idle_timeout": 89,    "sso_max_lifespan": 62,    "update_profile_on_soc_login": true,    "verify_email": false,    "master_admin_client": "JUbkDDSvUINdRVXTHPiXUBlLn",    "login_lifespan": 76,    "internationalization_enabled": true,    "default_locale": "nAbJDhYdHoXKYsJkluoMZXjLE",    "reg_email_as_username": false,    "admin_events_enabled": false,    "admin_events_details_enabled": true,    "edit_username_allowed": true,    "otp_policy_counter": 94,    "otp_policy_window": 94,    "otp_policy_period": 8,    "otp_policy_digits": 56,    "otp_policy_alg": "QQCZcymlSyVpmOcdurRJKVnlv",    "otp_policy_type": "mBQEZGjwhikuUHrZHvwGVGofR",    "browser_flow": "WCSJoqlUNmYfMjOwwLCMbPekl",    "registration_flow": "OFmvuyenOWJAxMWraOJZDguxp",    "direct_grant_flow": "bQaZegRUefisxTsaYtsBQGVYB",    "reset_credentials_flow": "HvIvEBMPvZIZMqtnEGaFgajCU",    "client_auth_flow": "ujdkHlRSMlqdECXkkaLERpQSP",    "offline_session_idle_timeout": 31,    "revoke_refresh_token": false,    "access_token_life_implicit": 16,    "login_with_email_allowed": false,    "duplicate_emails_allowed": false,    "docker_auth_flow": "XRgPudXUfBsYTmCAAoenDtAaW",    "refresh_token_max_reuse": 19,    "allow_user_managed_access": true,    "sso_max_lifespan_remember_me": 93,    "sso_idle_timeout_remember_me": 96,    "default_role": "AKQjKvwbOmbrokGIQQlqhCwNL"}
