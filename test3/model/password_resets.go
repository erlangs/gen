...
JSON Sample
-------------------------------------
{    "email": "CUEMFCPHxqFlrrvfSrDueqxJI",    "token": "qyOBhtHkVCfkXbOLBKwCvNALE",    "created_at": "2074-09-23T07:53:04.07671926+08:00"}
...
func (p *PasswordResets) BeforeSave(tx *gorm.DB) error {
	return nil
}
