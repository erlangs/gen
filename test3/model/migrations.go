...
JSON Sample
-------------------------------------
{    "id": 34,    "migration": "bZkldTEruxWMATLtFQpKhbcUH",    "batch": 57}
...
// Migrations struct is a row record of the migrations table in the test1 database
...
func (m *Migrations) BeforeSave(tx *gorm.DB) error {
	return nil
}
