...
// echo '{"id": 34,"migration": "bZkldTEruxWMATLtFQpKhbcUH","batch": 57}' | http POST "http://localhost:8080/migrations" X-Api-User:user123
...
// echo '{"id": 34,"migration": "bZkldTEruxWMATLtFQpKhbcUH","batch": 57}' | http PUT "http://localhost:8080/migrations/1"  X-Api-User:user123
