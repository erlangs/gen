...
// echo '{"id": 50,"migration": "ioRcHKoEjiaVRmsvhTEPLkMcv","batch": 40}' | http POST "http://localhost:8080/migrations" X-Api-User:user123
...
// echo '{"id": 50,"migration": "ioRcHKoEjiaVRmsvhTEPLkMcv","batch": 40}' | http PUT "http://localhost:8080/migrations/1"  X-Api-User:user123
